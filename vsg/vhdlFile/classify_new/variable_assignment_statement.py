...
from vsg.vhdlFile.classify_new import conditional_variable_assignment
from vsg.vhdlFile.classify_new import selected_variable_assignment
from vsg.vhdlFile.classify_new import simple_variable_assignment
