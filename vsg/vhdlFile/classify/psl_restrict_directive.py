...
from vsg.token.psl import restrict_directive as token
from vsg.vhdlFile import utils


def detect(iToken, lObjects):
    """
    [ label : ] Restrict_Directive
...
def classify(iToken, lObjects):
    iCurrent = utils.assign_next_token_required("restrict", token.restrict_keyword, iToken, lObjects)
