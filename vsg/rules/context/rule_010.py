...
class rule_010(move_item_next_to_another_item_rule):
    '''
    ...
    def __init__(self):
        move_item_next_to_another_item_rule.__init__(self, 'context', '010', token.end_context_keyword, token.context_simple_name)
        self.solution = None
        self.subphase = 2
