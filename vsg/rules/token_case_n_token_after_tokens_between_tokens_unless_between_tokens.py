...
class token_case_n_token_after_tokens_between_tokens_unless_between_tokens(case.Rule):
    """
    ...
    def __init__(self, iToken, lTokens, oStart, oEnd, lUnless, bLimitToVhdlKeywords=False):
        super().__init__()
        self.solution = None
        self.phase = 6
        self.case = "lower"
    ...
    def _get_tokens_of_interest(self, oFile):
        return oFile.get_n_token_after_tokens_between_tokens_unless_between_tokens(self.iToken, self.lTokens, self.oStart, self.oEnd, self.lUnless)
