...
class rule_037(align_tokens_in_region_between_tokens_unless_between_tokens):
    '''
    Process rule 037 checks the alignment of declaration identifiers in the process declarative region.
    '''

    def __init__(self):
        align_tokens_in_region_between_tokens_unless_between_tokens.__init__(self, 'process', '037', lAlign, oStart, oEnd, lUnless)
