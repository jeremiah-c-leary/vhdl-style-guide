...
class rule_410(align_tokens_in_region_between_tokens):
    ...
    def __init__(self):
        align_tokens_in_region_between_tokens.__init__(self, 'procedure', '410', lAlign, token.procedure_specification.open_parenthesis, token.procedure_specification.close_parenthesis)
        self.solution = 'Align :.'
