...
class rule_022(single_space_between_token_pairs_bounded_by_tokens):
    '''
    Checks for a single space after the => operator in port maps.
    '''
    def __init__(self):
        single_space_between_token_pairs_bounded_by_tokens.__init__(self, 'instantiation', '022', lTokens, lStart, lEnd)
