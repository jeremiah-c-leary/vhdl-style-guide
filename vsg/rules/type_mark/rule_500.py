...
class rule_500(token_case_with_prefix_suffix):
    ...
    **Fix**
    ...
    def _get_tokens_of_interest(self, oFile):
        ...
        lAllDicts = cc_utils.get_token_of_interest_dicts(oFile, lTokens, lDeclarationTokens, self.bIncludeDeclarativePartNames, self.bIncludeArchitectureBodyDeclarationsInSubprogramBody)
        lReturn = []
