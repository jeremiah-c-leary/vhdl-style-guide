...
class insert_carriage_return_after_token_if_it_is_not_followed_by_a_comment_when_between_tokens_unless_between_tokens(structure.Rule):
    """
    ...
    def __init__(self, lTokens, lTokenPairs, lUnless):
        super().__init__()
