...
class testRulePortMethods(unittest.TestCase):
    ...
    def test_rule_011_prefix(self):
        ...
        dExpected = [12,13,14,29,30,31,43,44,45,60,61,62,74,75,76,99,100,101,152,161]
        oRule.analyze(oFile)
        self.assertEqual(oRule.violations, dExpected)
    ...
    def test_rule_011_suffix(self):
        ...
        dExpected = [9,10,11,12,13,14,26,27,28,29,30,31,40,41,42,43,44,45,57,58,59,60,61,62,71,72,73,74,75,76,87,88,89,119,120,121,129,130,131,141,142,152,161]
        oRule.analyze(oFile)
        self.assertEqual(oRule.violations, dExpected)
