...
class testVhdlFileProcedureAssignments(unittest.TestCase):
    ...
    def test_isProcedureKeyword(self):
        lExpected = [4,6,14,16,26,30,40,44,54,63,72,84,96]
        # Generic actual list
        lActual = []
    ...
    def test_isProcedureBegin(self):
        lExpected = [27,35,41,49,60,69,79,91,99]
        # Generic actual list
        lActual = []
        for iIndex, oLine in enumerate(oFile.lines):
    ...
    def test_isProcedureEnd(self):
        lExpected = [4,10,14,20,28,36,42,50,61,70,80,92,100]
        # Generic actual list
        lActual = []
        for iIndex, oLine in enumerate(oFile.lines):
    ...
    def test_isProcedureParameter(self):
        lExpected = [7,8,9,10,17,18,19,20,31,32,33,34,44,45,46,47,48,55,56,57,58,64,65,66,67,73,74,75,76,85,86,87,88,97]
        # Generic actual list
        lActual = []
        for iIndex, oLine in enumerate(oFile.lines):
    ...
    def test_isProcedureParameterEnd(self):
        lExpected = [10,20,34,48,58,67,77,88,97]
        # Generic actual list
        lActual = []
        for iIndex, oLine in enumerate(oFile.lines):
    ...
    def test_isProcedureIs(self):
        lExpected = [26,34,40,48,59,68,78,88,98]
        # Generic actual list
        lActual = []
        for iIndex, oLine in enumerate(oFile.lines):
