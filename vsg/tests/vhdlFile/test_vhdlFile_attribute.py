...
class testVhdlFileAttributeAttributeMethods(unittest.TestCase):
    ...
    def test_keyword(self):
        ...
        utils.validate_token(self, oFile, lExpected, parser.attribute_keyword)
    ...
    def test_identifier(self):
        ...
        utils.validate_token(self, oFile, lExpected, parser.attribute_identifier)
    ...
    def test_colon(self):
        ...
        utils.validate_token(self, oFile, lExpected, parser.attribute_colon)
    ...
    def test_type_mark(self):
        ...
        utils.validate_token(self, oFile, lExpected, parser.attribute_type_mark)
    ...
    def test_semicolon(self):
        ...
        utils.validate_token(self, oFile, lExpected, parser.attribute_semicolon)
