...
from vsg.rules import rule_port
from vsg import vhdlFile


oFile = vhdlFile.vhdlFile(os.path.join(os.path.dirname(__file__),'..','rule_port','port_test_input.vhd'))
