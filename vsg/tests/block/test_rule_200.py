...
lFile = utils.read_vhdlfile(os.path.join(sTestDir,'rule_200_test_input.vhd'))

lExpected = []
lExpected.append('')
utils.read_file(os.path.join(sTestDir, 'rule_200_test_input.fixed.vhd'), lExpected, False)
