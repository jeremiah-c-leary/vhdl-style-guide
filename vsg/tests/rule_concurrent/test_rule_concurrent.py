...
from vsg.rules import rule_concurrent
from vsg import vhdlFile

# Read in test file used for all tests
oFile = vhdlFile.vhdlFile(os.path.join(os.path.dirname(__file__),'..','rule_concurrent','concurrent_test_input.vhd'))
...
class testRuleConcurrentMethods(unittest.TestCase):
    ...
    def test_rule_006(self):
        oRule = rule_concurrent.rule_006()
        self.assertTrue(oRule)
        self.assertEqual(oRule.name, 'concurrent')
