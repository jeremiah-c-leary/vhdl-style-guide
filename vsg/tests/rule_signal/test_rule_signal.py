...
from vsg.rules import rule_signal
from vsg import vhdlFile

# Read in test file used for all tests
oFile = vhdlFile.vhdlFile(os.path.join(os.path.dirname(__file__),'..','rule_signal','signal_test_input.vhd'))
