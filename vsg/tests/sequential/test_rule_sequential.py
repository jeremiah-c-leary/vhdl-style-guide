...
class testRuleSequentialMethods(unittest.TestCase):
    ...
    def test_rule_005(self):
        ...
        dExpected = [{'lines': [{'number': 13, 'keyword_column': 6},
                                {'number': 14, 'keyword_column': 4},
                                {'number': 15, 'keyword_column': 6}], 'max_keyword_column': 6},
                     {'lines': [{'number': 20, 'keyword_column': 11},
                                {'number': 21, 'keyword_column': 10},
                                {'number': 22, 'keyword_column': 10}], 'max_keyword_column': 11},
                     {'lines': [{'number': 26, 'keyword_column': 10},
                                {'number': 27, 'keyword_column': 10},
                                {'number': 28, 'keyword_column': 8}], 'max_keyword_column': 10},
