...
class test_selected_waveform_assignment_rule(unittest.TestCase):
    ...
    def test_rule_500_lower(self):
        oRule = selected_waveform_assignment.rule_500()
        self.assertTrue(oRule)
        self.assertEqual(oRule.name, 'selected_waveform_assignment')
