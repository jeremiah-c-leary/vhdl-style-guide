...
class test_selected_expressions_rule(unittest.TestCase):
    ...
    def test_rule_500_lower(self):
        oRule = selected_expressions.rule_500()
        self.assertTrue(oRule)
        self.assertEqual(oRule.name, 'selected_expressions')
        self.assertEqual(oRule.identifier, '500')

        lExpected = [10, 11, 15, 16]
