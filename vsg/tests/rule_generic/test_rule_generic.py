...
from vsg.rules import rule_generic
from vsg import vhdlFile


oFile = vhdlFile.vhdlFile(os.path.join(os.path.dirname(__file__),'..','rule_generic','generic_test_input.vhd'))
