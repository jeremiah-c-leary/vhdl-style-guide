...
#        utils.debug_lines(self.oFile, 22, 11)
        ...
        self.assertEqual(self.oFile.lines[26].line, '    file     file1  : load_file_file open read_mode is load_file_name;')
        ...
        self.assertEqual(self.oFile.lines[30].line, '    file     file12 : load_file_file open read_mode is load_file_name;')
        ...
        self.assertEqual(self.oFile.lines[40].line, '    file     file1  : load_file_file open read_mode is load_file_name;')
        ...
        self.assertEqual(self.oFile.lines[44].line, '    file     file12 : load_file_file open read_mode is load_file_name;')
        oRule.analyze(self.oFile)
