...
class test_block_comment_rule(unittest.TestCase):
    ...
    def test_rule_003_exclamation(self):
        oRule = block_comment.rule_003()
        oRule.footer_left = '!'
        oRule.max_footer_column = 80

        lExpected = [4, 8, 16, 20, 24]

        oRule.analyze(self.oFile)
        self.assertEqual(lExpected, utils.extract_violation_lines_from_violation_object(oRule.violations))

    def test_rule_003_exclamation_w_footer_string_centered(self):
        oRule = block_comment.rule_003()
        oRule.footer_left = '!'
        oRule.max_footer_column = 80
        ...
        lExpected = [4, 8, 12, 20, 24]

        oRule.analyze(self.oFile)
        self.assertEqual(lExpected, utils.extract_violation_lines_from_violation_object(oRule.violations))

    def test_rule_003_exclamation_w_footer_string_left_justified(self):
        oRule = block_comment.rule_003()
        oRule.footer_left = '!'
        oRule.max_footer_column = 80
        oRule.footer_string = '[ abcdef ]'
        ...
        lExpected = [4, 8, 12, 16, 24]

        oRule.analyze(self.oFile)
        self.assertEqual(lExpected, utils.extract_violation_lines_from_violation_object(oRule.violations))

    def test_rule_003_exclamation_w_footer_string_right_justified(self):
        oRule = block_comment.rule_003()
        oRule.footer_left = '!'
        oRule.max_footer_column = 80
        oRule.footer_string = '[ abcdef ]'
