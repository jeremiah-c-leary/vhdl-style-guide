...
#utils.read_file(os.path.join(sTestDir, 'rule_400_test_input.fixed_align_left_no_align_paren_no.vhd'), lExpected_align_left_no_align_paren_no)
#
#lExpected_align_left_no_align_paren_yes = []
#lExpected_align_left_no_align_paren_yes.append('')
#utils.read_file(os.path.join(sTestDir, 'rule_400_test_input.fixed_align_left_no_align_paren_yes.vhd'), lExpected_align_left_no_align_paren_yes)
...
#utils.read_file(os.path.join(sTestDir, 'rule_400_test_input.fixed_align_left_yes_align_paren_yes.vhd'), lExpected_align_left_yes_align_paren_yes)
...
#    def test_rule_400_align_left_no_align_paren_yes(self):
...
#
#    def test_fix_rule_400_align_left_no_align_paren_yes(self):
#        oRule = selected_assignment.rule_400()
#        oRule.align_left = 'no'
#        oRule.align_paren = 'yes'
#
...
#    def test_rule_400_align_left_yes_align_paren_yes(self):
#        oRule = selected_assignment.rule_400()
#        oRule.align_left = 'yes'
#        oRule.align_paren = 'yes'
#
...
#        self.assertEqual(lExpected, utils.extract_violation_lines_from_violation_object(oRule.violations))
#
#    def test_fix_rule_400_align_left_yes_align_paren_yes(self):
#        oRule = selected_assignment.rule_400()
#        oRule.align_left = 'yes'
#        oRule.align_paren = 'yes'
#
...
#        self.assertEqual(oRule.violations, [])
#
#    def test_rule_400_align_left_no_align_paren_no(self):
#        oRule = selected_assignment.rule_400()
#        oRule.align_left = 'no'
#        oRule.align_paren = 'no'
#
...
#        self.assertEqual(lExpected, utils.extract_violation_lines_from_violation_object(oRule.violations))
#
#    def test_fix_rule_400_align_left_no_align_paren_no(self):
#        oRule = selected_assignment.rule_400()
#        oRule.align_left = 'no'
#        oRule.align_paren = 'no'
#
