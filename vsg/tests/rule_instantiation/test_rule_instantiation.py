...
from vsg.rules import rule_instantiation
from vsg import vhdlFile


oFilePort = vhdlFile.vhdlFile(os.path.join(os.path.dirname(__file__),'..','rule_instantiation','instantiation_test_input.vhd'))
...
class testRuleInstantiationMethods(unittest.TestCase):
    ...
    def test_rule_019(self):
        oRule = rule_instantiation.rule_019()
        self.assertTrue(oRule)
        self.assertEqual(oRule.name, 'instantiation')
