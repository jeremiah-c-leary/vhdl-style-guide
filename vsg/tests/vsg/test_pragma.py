...
class testMain(unittest.TestCase):
    ...
    def test_default_pragmas(self, mock_stdout):
        ...
        sys.argv = ['vsg']
        sys.argv.extend(['-f', 'vsg/tests/vsg/pragmas/pragmas.vhd'])
    ...
    def test_configuring_pragmas(self, mock_stdout):
        ...
        sCall += '\n'
        sCall += 'ERROR: vsg/tests/vsg/pragmas/pragmas.vhd(9)comment_010 -- Use 2 spaces for indent'
        sCall += '\n'
        ...
        sys.argv = ['vsg']
        sys.argv.extend(['--configuration', 'vsg/tests/vsg/pragmas/config_pragma.json'])
        sys.argv.extend(['--output_format', 'syntastic'])
        sys.argv.extend(['-p 1'])
