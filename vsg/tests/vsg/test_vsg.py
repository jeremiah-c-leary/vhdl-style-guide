...
class testVsg(unittest.TestCase):
    ...
    def test_multiple_yaml_configuration_w_multiple_filelists(self):
        ...
        lActual = subprocess.check_output(['bin/vsg','--configuration','vsg/tests/vsg/config_1.yaml','vsg/tests/vsg/config_2.yaml','--output_format','syntastic']).split('\n')
        self.assertEqual(lActual, lExpected)
    ...
    def test_single_yaml_configuration_w_rule_disable(self):
        ...
        lActual = subprocess.check_output(['bin/vsg','--configuration','vsg/tests/vsg/config_3.yaml','--output_format','syntastic','-f','vsg/tests/vsg/entity1.vhd']).split('\n')
        self.assertEqual(lActual, lExpected)
    ...
    def test_multiple_yaml_configuration_w_rule_disable(self):
        ...
        lActual = subprocess.check_output(['bin/vsg','--configuration','vsg/tests/vsg/config_3.yaml','vsg/tests/vsg/config_4.yaml','--output_format','syntastic','-f','vsg/tests/vsg/entity1.vhd']).split('\n')
        self.assertEqual(lActual, lExpected)
    ...
    def test_reverse_yaml_multiple_configuration_w_rule_disable(self):
        ...
        lActual = subprocess.check_output(['bin/vsg','--configuration','vsg/tests/vsg/config_4.yaml','vsg/tests/vsg/config_3.yaml','--output_format','syntastic','-f','vsg/tests/vsg/entity1.vhd']).split('\n')
        self.assertEqual(lActual, lExpected)
    ...
    def test_globbing_filenames_in_yaml_configuration(self):
        ...
        lActual = subprocess.check_output(['bin/vsg','--configuration','vsg/tests/vsg/config_glob.yaml','--output_format','syntastic']).split('\n')
        self.assertEqual(lActual, lExpected)
