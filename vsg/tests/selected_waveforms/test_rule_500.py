...
class test_selected_waveforms_rule(unittest.TestCase):
    ...
    def test_rule_500_lower(self):
        oRule = selected_waveforms.rule_500()
        self.assertTrue(oRule)
        self.assertEqual(oRule.name, 'selected_waveforms')
        self.assertEqual(oRule.identifier, '500')

        lExpected = [10, 11, 17, 18]
