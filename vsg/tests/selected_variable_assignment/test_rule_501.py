...
class test_selected_variable_assignment_rule(unittest.TestCase):
    ...
    def test_rule_501_lower(self):
        oRule = selected_variable_assignment.rule_501()
        self.assertTrue(oRule)
        self.assertEqual(oRule.name, 'selected_variable_assignment')
