...
Example: Change indenting of process arguments
----------------------------------------------

The current rule **process_020** aligns the process arguments with the opening parenthesis for multiline arguments.
However, we want to indent the multilines two spaces from the process label:
