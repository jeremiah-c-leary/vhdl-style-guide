...
class test_rule(unittest.TestCase):
    ...
    def test_rule_008_lower(self):
        ...
        lExpected.extend(range(69, 73))
        lExpected.extend(range(74, 78))
        lExpected.extend(range(81, 88))
