...
class test_rule(unittest.TestCase):
    ...
    def test_rule_100(self):
        oRule = external_signal_name.rule_100()
        self.assertTrue(oRule)
        self.assertEqual(oRule.name, "external_signal_name")
    ...
    def test_fix_rule_100(self):
        ...
        utils.read_file(os.path.join(sTestDir, "rule_100_test_input.fixed.vhd"), lExpected_spaces)
