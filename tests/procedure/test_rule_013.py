...
utils.read_file(os.path.join(sTestDir, 'rule_013_test_input.fixed_interface_list_semicolon__remove_new_line.vhd'), lExpected_interface_list_semicolon__remove_new_line)
