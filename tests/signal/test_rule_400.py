...
class test_rule(unittest.TestCase):
    ...
    def test_rule_400__align_left_true__align_paren_false(self):
        oRule = signal.rule_400()
    ...
    def test_rule_400__align_left_false__align_paren_false(self):
        oRule = signal.rule_400()
    ...
    def test_rule_400__align_left_false__align_paren_true(self):
        oRule = signal.rule_400()
        oRule.align_left = False
    ...
    def test_rule_400__align_left_true__align_paren_true(self):
        oRule = signal.rule_400()
        oRule.align_left = True
        oRule.align_paren = True
        self.assertTrue(oRule)
