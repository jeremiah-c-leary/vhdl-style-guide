...
class test_choice_rule(unittest.TestCase):
    def setUp(self):
        self.oFile = vhdlFile.vhdlFile(lFile)
        self.assertIsNone(eError)

    def test_rule_500_lower(self):
        oRule = choice.rule_500()
        self.assertTrue(oRule)
        self.assertEqual(oRule.name, "choice")
        self.assertEqual(oRule.identifier, "500")

        lExpected = [41, 43, 43, 43, 49, 51, 51, 51, 54, 56, 56, 56, 59, 66]
    ...
    def test_rule_500_upper(self):
        ...
        lExpected = [9, 11, 11, 11, 17, 19, 19, 19, 22, 24, 24, 24, 27, 34]
